...
### GENERAL
- Split out TRACE log level from DEBUG, creating a 5th log level

### DOCUMENTATION
- Updated README to describe TRACE custom log level and give implementation instructions
- Updated README to include instructions on defining infix string formatting for variables in log messaging
- Added real-world log message examples to README
- Added 'Usage guide (advanced)' to README to match guide in code file
- Tweaked wording, examples in code file

## [1.07.1a] - 2025-12-02

### GENERAL
- Fixed an issue that prevented FAIL-SLOW from being properly tallied
- Changed minimum # of tests needed to engage overall progress monitoring from >50 to ≥50
